...
class RolloutControlAgent(GameAwareTierLoadoutControlAgent):
    """Control rollout pilot that searches GP choices and keeps heuristic keep logic."""
    ...
    def choose_god_power(self, state: GameState, player_num: int) -> tuple[str, int] | None:
        ...
        return choose_gp_by_rollout(
            ...
            current_heuristic_cls=GameAwareTierLoadoutControlAgent,
        )
