...
l0_random.py
------------
L0 symmetry check: RandomAgent mirror with no God Powers.
...
Run:
    python -m simulator.l0_random
    python -m simulator.l0_random --games 2000
    python -m simulator.l0_random --die DIE_WARRIOR
"""
